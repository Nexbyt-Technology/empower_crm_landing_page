    ...
    <footer className='bg-primary text-white pt-20 pb-12'>
        ...
        <div className='flex flex-col md:flex-row justify-between md:gap-24 gap-16 mb-16'>
            ...
            <div className='md:w-1/3'>
                <Link to='/' className='text-2xl font-bold mb-4 inline-block'><span className='text-yellow-700 flex items-center'><img src="/fav-icon.jpg" className='max-w-17 px-2'/>Empowa CRM</span></Link>
                <p className='text-gray-400 md:2/3'>The first CRM to deliver truly personalized customer insights—transforming how you manage relationships.</p>
            </div>
        ...
        <div className='border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center'>
            ...
            <div className='text-gray-400 text-sm'>
                {new Date().getFullYear} Empowa CRM. All rights reserved
            </div>
        </div>
        </div>
    </footer>
